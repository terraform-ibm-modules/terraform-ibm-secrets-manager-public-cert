...
| <a name="input_endpoint_type"></a> [endpoint\_type](#input\_endpoint\_type) | Service endpoint type to communicate with the provided secrets manager instance. Possible values are `public` or `private` | `string` | `"public"` | no |
